...
data = dict(
    ...
    sampler=dict(
        train=dict(
            ...
            by_prob=True,
            epoch_length=2000)))
evaluation = dict(interval=2000, metric='bbox', type='SubModulesDistEvalHook')
...
checkpoint_config = dict(interval=2000, by_epoch=False, max_keep_ckpts=20)
log_config = dict(
...
work_dir = './work_dirs/soft_teacher_faster_rcnn_r50_caffe_fpn_coco_nodule'
cfg_name = 'soft_teacher_faster_rcnn_r50_caffe_fpn_coco_nodule'
gpu_ids = range(0, 1)
